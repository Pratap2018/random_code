...
export const HYPERSIGN_NETWORK_SCHEMA_PATH =
  "hypersign-protocol/hidnode/ssi/schema";
export const HYPERSIGN_NETWORK_CREDENTIALSTATUS_PATH =
...
export const VC = {
  ...
  CREDENTAIL_ECDSA_SECURITY_SUITE:
